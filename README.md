...
- **Март**
  ...
  - **Апрель**
  - тест-дизайн для `GET /posts?userId=` (эквивалентные классы и граничные значения)
  - data-driven автотесты, напрямую соответствующие таблице кейсов APR-01..APR-08
  - проверка фильтрации по query-параметру `userId`
  - документ `TEST_DESIGN_APRIL.md` с таблицей кейсов и трассировкой
  - документ `APRIL_REPORT.md` с описанием расширения покрытия
